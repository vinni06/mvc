...
<div class="form-row">
  <div class="form-group col-md-6">
   ...
   <div class="form-group col-md-6">
    ...
    <input type="number" class="form-control" id="mobileNo" name="mobileNo" placeholder="Enter mobile No">
  </div>
  </div>
  <div class="form-group col-md-6">
    <label >Email</label>
   ...
   <div class="form-group col-md-6">
    <label >DOJ</label>
    <input type="date" class="form-control" id="DOJ" name="DOJ" placeholder="Enter DOJ">
  </div>
  </div>
  <div class="form-group col-md-6">
    <label >merit</label>
